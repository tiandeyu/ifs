...
* ----------------------------------------------------------------------------
* File        : ComponentHistory.java
* Description :
* Notes       :
* ----------------------------------------------------------------------------
* Modified    :
*    Dushmantha D  2008-August-04 - Created
* ----------------------------------------------------------------------------
*
*/
...
public class ComponentHistory extends ASPPageProvider
{

   //===============================================================
   // Static constants
   //===============================================================
   public static boolean DEBUG = Util.isDebugEnabled("ifs.fnd.pages.ComponentHistory");
   ...
   // Construction
   //===============================================================
   public ComponentHistory(ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   {
      ComponentHistory page = (ComponentHistory)(super.clone(obj));
   ...
   public void run() throws FndException
   {
      ...
      has_access = isObjectAccessible("FND/ComponentHistory.page");
