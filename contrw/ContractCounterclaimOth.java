...
public class ContractCounterclaimOth extends HzASPPageProviderWf
{
   ...
   public  ContractCounterclaimOth (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
   ...
   {
      return "CONTRACTCOUNTERCLAIMOTHDESC: Contract Counterclaim Oth";
   }
  

   protected String getTitle()
   {
      return "CONTRACTCOUNTERCLAIMOTHTITLE: Contract Counterclaim Oth";
   }
