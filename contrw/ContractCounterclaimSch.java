...
public class ContractCounterclaimSch extends HzASPPageProviderWf
{
   ...
   public  ContractCounterclaimSch (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
   ...
   public void preDefine()
   {
      ...
      headbar.addSecureCustomCommand("Release","CONTRACTCOUNTERCLAIMSCHRELEASE: Release Contract Counterclaim", "CONTRACT_VARIATION_API.Release__");
   ...
   {
      return "CONTRACTCOUNTERCLAIMSCHDESC: Contract Counterclaim Sch";
   }


   protected String getTitle()
   {
      return "CONTRACTCOUNTERCLAIMSCHTITLE: Contract Counterclaim Sch";
   }
