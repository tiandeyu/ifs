...
public class ProjectContractSch extends ProjectContractBase {

	// -----------------------------------------------------------------------------
	// ---------- Static constants ------------------------------------------------
	// -----------------------------------------------------------------------------

	public static boolean DEBUG = Util.isDebugEnabled("ifs.contrw.ProjectContractSch");
	...
	public ProjectContractSch(ASPManager mgr, String page_path) {
		super(mgr, page_path);
	}
	...
	public void okFind()
	{
		...
		q.addWhereCondition("SCHEDULE = 'TRUE'");
	...
	public void newRow()
	{
		...
		data.setFieldItem("SCHEDULE", "TRUE");
		headset.addRow(data);  
	}  
   ...
   public void adjust()
   {
      ...
      ASPManager mgr = getASPManager();
      super.adjust();
      mgr.getASPField("ITEM_NOTE").setSize(60);
   }      
	...
	protected String getDescription() {
		return "PROJECTCONTRACTSCHDESC: Schedule Project Contract";
	}
