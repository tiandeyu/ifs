...
public class ContractPaymentOth extends HzASPPageProviderWf  
{
   ...
   public  ContractPaymentOth (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
...
//    q.addWhereCondition("Project_Contract_Access_API.Check_Current_Access(CONTRACT_ID) = 'TRUE'");
   ...
   public void newRowITEM1()
   {
      ...
      cmd = trans.addEmptyCommand("ITEM1","CONTRACT_PAYMENT_ITEM_API.New__",contract_payment_item_blk);
      cmd.setOption("ACTION","PREPARE");
      cmd.setParameter("ITEM0_PROJ_NO", headset.getValue("PROJ_NO"));
      cmd.setParameter("ITEM0_CONTRACT_ID", headset.getValue("CONTRACT_ID"));
      cmd.setParameter("ITEM0_PAYMENT_NO", headset.getValue("PAYMENT_NO"));
      trans = mgr.perform(trans);
      data = trans.getBuffer("ITEM1/DATA");
      contract_payment_item_set.addRow(data);
   }
...
//      mgr.getASPField("PAY_SUPP_FILES").setValidation("PAY_SUPP_FILES_DESC");
   // 6
      headblk.addField("CHANGE_PRICE","Number","#0.00").
              ...
              setSize(20); 
      headblk.addField("PAYMENT_SCALE","Money","#0.00").
              setInsertable().
              setLabel("CONTRACTPAYMENTPAYMENTSCALE: Payment Scale").
              setSize(30);    
      ...
      headblk.addField("NOTE").     
              ...
              setSize(120).
              setHeight(4);
      headblk.addField("UNDERTAKE_DEPT").setHidden();
      headblk.addField("UNDERTAKE_DEPT_NAME").setHidden();
      ...
      headbar.addCustomCommand("import_Payment_Item","CONTRACTPAYMENTIMPORTPAYMENTITEM: Import Payment Item..");
      ...
      headbar.addCustomCommand("printReport", "CONTRACTPAYMENTPRINTREPORT: Print Report...");
      ...
      headbar.addCustomCommand("printReportPrePay", "PROJECTCONTRACTPRINTREPORTPREPAY: Print Report Pre Pay...");
      headbar.addCustomCommand("printReportPayApply", "PROJECTCONTRACTPRINTREPORTPAYAPPLY: Print Report Pay Apply...");
      headbar.addCustomCommand("printReportPreApproval", "PROJECTCONTRACTPRINTREPORTPREAPPROVAL: Print Report Pre Approval...");
      headbar.addCustomCommand("printReportFinalApply", "PROJECTCONTRACTPRINTREPORTFINALAPPLY: Print Report Final Apply...");
      headbar.addCustomCommand("printReportFinalApproval", "PROJECTCONTRACTPRINTREPORTFINALAPPROVAL: Print Report Final Approval...");
...
//      headlay.setSimple("PAY_SUPP_FILES_DESC");
      ...
      contract_payment_item_blk.addField("ITEM0_PROJ_NO").
                                ...
                                setInsertable().
                                setHidden().
                                setLabel("CONTRACTPAYMENTITEMITEM0PROJNO: Proj No").
                                setSize(50);
      contract_payment_item_blk.addField("ITEM0_CONTRACT_ID").
                                ...
                                setInsertable().
                                setHidden().
                                setLabel("CONTRACTPAYMENTITEMITEM0CONTRACTID: Contract Id").
                                setSize(20);
      contract_payment_item_blk.addField("ITEM0_PAYMENT_NO", "Number").
                                setDbName("PAYMENT_NO").
                                setMandatory().
                                setInsertable().
                                setHidden().
                                setLabel("CONTRACTPAYMENTITEMITEM0PAYMENTNO: Payment No").
                                setSize(10);
      // 1
      contract_payment_item_blk.addField("ITEM_NO").
                                ...
                                setLabel("CONTRACTPAYMENTITEMITEMNO: Item No").
                                setSize(20);
      contract_payment_item_blk.addField("ITEM_DESC").
                                setReadOnly().
                                setLabel("CONTRACTPAYMENTITEMITEMDESC: Item Desc").
                                setSize(30);
      ...
      contract_payment_item_blk.addField("ITEM_TYPE").
                                ...
                                setLabel("CONTRACTPAYMENTITEMITEMTYPE: Item Type").
                                setSize(10);
      contract_payment_item_blk.addField("ITEM_UNIT").
                                setReadOnly().
                                setDynamicLOV("ISO_UNIT").
                                setLabel("CONTRACTPAYMENTITEMITEMUNIT: Item Unit").
                                setSize(10);
      contract_payment_item_blk.addField("ITEM_UNIT_DESC").
                                setReadOnly().
                                setLabel("CONTRACTPAYMENTITEMITEMUNITDESC: Item Unit Desc").
                                setFunction("Iso_Unit_API.Get_Description(:ITEM_UNIT)").
                                setSize(10);
      mgr.getASPField("ITEM_UNIT").setValidation("ITEM_UNIT_DESC");
      
//      // 3
//      contract_payment_item_blk.addField("ITEM_CURRENCY").
//                                 setReadOnly().
//            setLabel("CONTRACTPAYMENTITEMITEMCURRENCY: Item Currency").
//            setDynamicLOV("ISO_CURRENCY").
//            setSize(10);
//      contract_payment_item_blk.addField("ITEM_CURRENCY_DESC").
//            setReadOnly().
//            setHidden().
//            setLabel("CONTRACTPAYMENTITEMITEMCURRENCYDESC: Item Currency Desc").
//            setFunction("Iso_Currency_API.Get_Description(:ITEM_CURRENCY)").
//            setSize(10);
//      mgr.getASPField("ITEM_CURRENCY").setValidation("ITEM_CURRENCY_DESC");
      
      contract_payment_item_blk.addField("EXCHANGE_RATE", "Number").
                                setReadOnly().    
                                setInsertable().        
                                setLabel("CONTRACTPAYMENTITEMEXCHANGERATE: Exchange Rate").
                                setSize(10);
      
      // 4
      contract_payment_item_blk.addField("PRICE", "Money","#0.00").
                                setReadOnly().
                                setLabel("CONTRACTPAYMENTITEMPRICE: Price").
                                setSize(20);
      ...
      contract_payment_item_blk.addField("QTY", "Number","#0.00").
                                setReadOnly().
                                setLabel("CONTRACTPAYMENTITEMQTY: Qty").
                                setSize(20);
      // 5
      contract_payment_item_blk.addField("TOTAL", "Money","#0.00").
                                setReadOnly().
                                setLabel("CONTRACTPAYMENTITEMTOTAL: Total").
                                setSize(20);
      
      contract_payment_item_blk.addField("OWNER_QTY", "Number","#0.00").
                                setInsertable().
                                setCustomValidation("PRICE,OWNER_QTY,EXCHANGE_RATE", "OWNER_TOTAL").
                                setLabel("CONTRACTPAYMENTITEMOWNERQTY: Owner Qty").
                                setSize(20);    
      
      // 6
      contract_payment_item_blk.addField("OWNER_TOTAL", "Money","#0.00").
                                setInsertable().
                                setLabel("CONTRACTPAYMENTITEMOWNERTOTAL: Owner Total").
                                setSize(20);
      
      contract_payment_item_blk.addField("PRE_OWNER_TOTAL", "Money","#0.00").
                                unsetInsertable().
                                setReadOnly().
                                setFunction("Contract_Payment_Item_API.Cal_All_Owner_Total(:ITEM0_PROJ_NO,:ITEM0_CONTRACT_ID, :ITEM0_PAYMENT_NO - 1, :ITEM_NO)").
                                setLabel("CONTRACTPAYMENTITEMPREOWNERTOTAL: Pre Owner Total").
                                setSize(20);
        
      // 7
      contract_payment_item_blk.addField("ALL_OWNER_TOTAL", "Money","#0.00").
                                unsetInsertable().
                                setReadOnly().
                                setFunction("Contract_Payment_Item_API.Cal_All_Owner_Total(:ITEM0_PROJ_NO,:ITEM0_CONTRACT_ID, :ITEM0_PAYMENT_NO, :ITEM_NO)").
                                setLabel("CONTRACTPAYMENTITEMALLOWNERTOTAL: All Owner Total").
                                setSize(20);
      contract_payment_item_blk.addField("ITEM_NOTE").
                                setInsertable().
                                setLabel("CONTRACTPAYMENTITEMITEMNOTE: Note").
                                setSize(50);     
      contract_payment_item_blk.setView("CONTRACT_PAYMENT_ITEM");
      contract_payment_item_blk.defineCommand("CONTRACT_PAYMENT_ITEM_API","New__,Modify__,Remove__");
      ...
      contract_payment_item_bar.defineCommand(contract_payment_item_bar.NEWROW, "newRowITEM1");
      contract_payment_item_tbl = mgr.newASPTable(contract_payment_item_blk);
      contract_payment_item_tbl.setTitle("CONTRACTPAYMENTITEMITEMHEAD1: ContractPaymentItem");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOth.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
   ...
   public void adjust() throws FndException
   {
      ...
      if( headlay.isSingleLayout() || headlay.isCustomLayout() && headset.countRows()>0){
         ...
         contract_payment_item_bar.disableCommand(contract_payment_item_bar.NEWROW);
      }  
      if(headlay.isMultirowLayout()){
         headset.storeSelections();    
   ...
   //-----------------------------------------------------------------------------
   public void  printReportPrePay() throws FndException, UnsupportedEncodingException
   {
    ASPManager mgr = getASPManager();
    ASPConfig cfg = getASPConfig();
    String URL=cfg.getParameter("APPLICATION/RUNQIAN/SERVER_URL");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String contract_id = headset.getValue("CONTRACT_ID");
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOthPrePay.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
                + "','_blank','height=600, width=780, top=200, left=350, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');");                                
         }
   } 
   public void  printReportPayApply() throws FndException, UnsupportedEncodingException
   {
    ASPManager mgr = getASPManager();
    ASPConfig cfg = getASPConfig();
    String URL=cfg.getParameter("APPLICATION/RUNQIAN/SERVER_URL");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String contract_id = headset.getValue("CONTRACT_ID");
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOthPayApply.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
                + "','_blank','height=600, width=780, top=200, left=350, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');");                                
         }
   } 
   public void  printReportPreApproval() throws FndException, UnsupportedEncodingException
   {
    ASPManager mgr = getASPManager();
    ASPConfig cfg = getASPConfig();
    String URL=cfg.getParameter("APPLICATION/RUNQIAN/SERVER_URL");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String contract_id = headset.getValue("CONTRACT_ID");
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOthPreApproval.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
                + "','_blank','height=600, width=780, top=200, left=350, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');");                                
         }
   }  
   public void  printReportFinalApply() throws FndException, UnsupportedEncodingException
   {
    ASPManager mgr = getASPManager();
    ASPConfig cfg = getASPConfig();
    String URL=cfg.getParameter("APPLICATION/RUNQIAN/SERVER_URL");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String contract_id = headset.getValue("CONTRACT_ID");
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOthFinalApply.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
                + "','_blank','height=600, width=780, top=200, left=350, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');");                                
         }
   } 
   public void  printReportFinalApproval() throws FndException, UnsupportedEncodingException
   {
    ASPManager mgr = getASPManager();
    ASPConfig cfg = getASPConfig();
    String URL=cfg.getParameter("APPLICATION/RUNQIAN/SERVER_URL");
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String contract_id = headset.getValue("CONTRACT_ID");
             String payment_no = headset.getValue("PAYMENT_NO");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptContractPaymentOthFinalApproval.raq&proj_no="+proj_no+"&contract_id="+contract_id+"&payment_no="+payment_no
                + "','_blank','height=600, width=780, top=200, left=350, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no');");                                
         }
   }
   
   
   public void import_Payment_Item(){
      ASPManager mgr = getASPManager();
      ...
      if (headlay.isSingleLayout())
         headset.selectRow();
      ASPBuffer selected_fields=headset.getSelectedRows("PROJ_NO,CONTRACT_ID,PAYMENT_NO");
      for(int i=0;i<selected_fields.countItems();i++){
         cmd=trans.addCustomCommand("import_Payment_Item"+i, "CONTRACT_PAYMENT_API.Import_Payment_Item");
         ASPBuffer subBuff = selected_fields.getBufferAt(i);
         String proj_no=subBuff.getValueAt(0);
         String contract_id=subBuff.getValueAt(1);
         String payment_no=subBuff.getValueAt(2);
         cmd.addParameter("PROJ_NO",proj_no); 
         cmd.addParameter("CONTRACT_ID",contract_id);
         cmd.addParameter("PAYMENT_NO",payment_no); 
    }
     trans = mgr.perform(trans);   
     mgr.showAlert("CONTRACTPAYMENTSUCCESSIMPORTED: Success Imported");
     headbar.disableCommand("import_Payment_Item");    
     okFindITEM1();    
   }
   ...
   public void validate()
   {
       ...
       if("OWNER_QTY".equals(val)){  
         tempValue = ((mgr.readValue("PRICE")==null)?0:Float.parseFloat(mgr.readValue("PRICE")))*((mgr.readValue("OWNER_QTY")==null)?0:Float.parseFloat(mgr.readValue("OWNER_QTY")))*((mgr.readValue("EXCHANGE_RATE")==null)?1:Float.parseFloat(mgr.readValue("EXCHANGE_RATE")));
   ...
   {
      return "CONTRACTPAYMENTOTHDESC: Contract Payment Oth";
   }


   protected String getTitle()
   {
      return "CONTRACTPAYMENTOTHTITLE: Contract Payment Oth";
   }
