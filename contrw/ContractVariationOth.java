...
public class ContractVariationOth extends HzASPPageProviderWf
{
   ...
   public  ContractVariationOth (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }    
   ...
   {
      return "CONTRACTVARIATIONOTHDESC: Contract Variation Other";
   }


   protected String getTitle()
   {
      return "CONTRACTVARIATIONOTHTITLE: Contract Variation Other"; 
   }
