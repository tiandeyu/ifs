...
public class ContractPaymentMat extends HzASPPageProviderWf  
{
   ...
   public  ContractPaymentMat (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
...
//      mgr.getASPField("ITEM_CURRENCY").setValidation("ITEM_CURRENCY_DESC");
   ...
   {
      return "CONTRACTPAYMENTMATDESC: Contract Payment Mat";
   }


   protected String getTitle()
   {
      return "CONTRACTPAYMENTMATTITLE: Contract Payment Mat";
   }
