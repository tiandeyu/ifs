...
public class MatEntryListToContractLineDlg extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.matmaw.MatEntryListToContractDlg");
   ...
   public  MatEntryListToContractLineDlg (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void okFind()
   {
      ...
      q.addWhereCondition("(CONTRACT_ID IS NULL OR ITEM_NO IS NULL) AND¡¡(PROJ_NO,ENTRY_ID) IN " +
...
//                            setSize(50);
   ...
   public void submitCondition(){
      ...
      for(int i=0;i<selected_fields.countItems();i++){         
         ...
         cmdBuf = trans.addCustomCommand("CREATECONDITION"+i, "MAT_ST_ENTRY_LINE_API.Create_File3");    
         ...
         cmdBuf.addParameter("CONTRACT_ID", ctx.findGlobal("CONTRACT_ID"));
         cmdBuf.addParameter("ITEM_NO", ctx.findGlobal("ITEM_NO"));
      }
      mgr.perform(trans);
   }
