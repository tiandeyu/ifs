...
public class DrawingListBorrowDlg extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.engmaw.DrawingListBorrowDlg");
   ...
   public  DrawingListBorrowDlg (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void submitItem(){
      ...
      ASPContext ctx =mgr.getASPContext();
       ...
       for(int i=0;i<selected_fields.countItems();i++){         
           ...
           cmdBuf = trans.addCustomCommand("CREATETREE"+i, "DRAWING_BORROW_LINE_API.Create_Drawing_Borrow_Line");
           cmdBuf.addParameter("PROJ_NO", ctx.findGlobal("DRAWINGBOWRROWLISTDLGPROJNO")); 
           cmdBuf.addParameter("BORROW_NO", ctx.findGlobal("DRAWINGBOWRROWLISTDLGID"));     
   ...
   public void okFind()
   {
      ...
      q.addWhereCondition("PROJ_NO = '"+ctx.findGlobal("DRAWINGBOWRROWLISTDLGPROJNO")+"'");
      q.addWhereCondition("VOLUME_NO NOT IN (SELECT VOLUME_NO FROM IFSAPP.DRAWING_BORROW_LINE WHERE BORROW_NO = '"+ctx.findGlobal("DRAWINGBOWRROWLISTDLGID")+"' )");
      q.includeMeta("ALL");      
   ...
   public void  preDefine()
   {
      ...
      headblk.defineCommand("DRAWING_LIST_API","");
