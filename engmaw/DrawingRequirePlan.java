...
public class DrawingRequirePlan extends ASPPageProvider
{
   ...
   public  DrawingRequirePlan (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void validate()
  {
   ...
   public void  preDefine()
   {
      ...
      headblk.addField("OBJVERSION").
              setHidden();
      headblk.addField("DRAW_REQ_NO").
              setMandatory().
              setInsertable().
              setLabel("DRAWINGREQUIREPLANDRAWREQNO: Draw Req No").
              setHidden().  
              setSize(20);  
      ...
      headblk.addField("DRAW_REQ_NAME").
              setInsertable().
              setLabel("DRAWINGREQUIREPLANDRAWREQNAME: Draw Req Name").
              setSize(30);
...
//              setInsertable().
      ...
      headblk.addField("REQ_MONTH").
              ...
              setMandatory().
              setInsertable().
              setLabel("DRAWINGREQUIREPLANREQMONTH: Req Month").
              setSize(20);   

      headblk.addField("REQ_YEAR").
              setInsertable().
              setLabel("DRAWINGREQUIREPLANREQYEAR: Req Year").
              setSize(20);
...
//      headlay.setSimple("REPORT_USER_NAME");
      headlay.setSimple("CONSTRUCTION_SITE_NAME");
      headlay.setDataSpan("REPORT_DATE", 5);
      ...
      drawing_require_plan_line_blk.addField("MACHINE_NO").
                                    setInsertable().
                                    setLabel("DRAWINGREQUIREPLANLINEMACHINENO: Machine No").
                                    setSize(20);      
      ...
      drawing_require_plan_line_blk.addField("BOOKLET_NO").
                                    setLabel("DRAWINGREQUIREPLANLINEBOOKLETNO: Booklet No").
...
//      mgr.getASPField("DOC_NO").setValidation("BOOKLET_NO");
      drawing_require_plan_line_blk.addField("BOOKLET_NAME").
                                    setLabel("DRAWINGREQUIREPLANLINEBOOKLETNAME: Booklet Name").
      ...
      drawing_require_plan_line_lay.setDataSpan("DOC_NO",6);
