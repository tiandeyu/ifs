...
public class ChangeDesg extends HzASPPageProviderWf
{ 
   ...
   public  ChangeDesg (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
   ...
   {
      return "CHANGEDESGDESC: Change Desg";
   }


   protected String getTitle()
   {
      return "CHANGEDESGTITLE: Change Desg";
   }
