...
import ifs.conmaw.ConCheckNotice;;

//-----------------------------------------------------------------------------
//-----------------------------   Class def  ------------------------------
//-----------------------------------------------------------------------------

public class HseCheckNotice extends ConCheckNotice
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.quamaw.ConCheckNotice");
...
//   private ASPBlockLayout headlay;
   ...
   public  HseCheckNotice (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
...
//   }
   ...
   public void okFind()
   {
      ...
      q.addParameter("CON_CHECK_LIST_TYPE_DB","SAFE");
      q.includeMeta("ALL");
   ...
   public void newRow()
   {
      ...
      data.setFieldItem("CON_CHECK_LIST_TYPE_DB", "SAFE");
      headset.addRow(data);
   }
...
//               "GENERAL_ZONE_API.Get_Zone_Desc", "CONSTRUCTION_ORG_NAME");
...
//
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String id = headset.getValue("ID");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptHseCheckNotice.raq&proj_no="+proj_no+"&id="+id
   ...
   {
      return "HSECHECKNOTICEDESC: Hse Check Notice";
   }


   protected String getTitle()
   {
      return "HSECHECKNOTICETITLE: Hse Check Notice";
   }
