...
public class HseAccidentHandleResult extends HzASPPageProviderWf
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.quamaw.HseAccidentHandleResult");
   ...
   public  HseAccidentHandleResult (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void okFind()
   {
      ...
      q.addWhereCondition(" quote_id is not null and is_plan is null and belong_to_lu = 'HseAccident'");
...
//              setWfProperties().
      ...
      headblk.addField("GENERAL_PROJECT_PROJ_DESC").
              ...
              setLabel("HSEACCIDENTHANDLERESULTPROJECTPROJDESC: General Project Proj Desc").
              setReadOnly().
              setSize(30);
      ...
      headblk.addField("QUA_ACCIDENT_NO").
              setMandatory().
              setInsertable().
              setLabel("HSEACCIDENTHANDLERESULTNO: Hse Accident No").
              setSize(30);
      ...
      headblk.addField("QUOTE_ID").
              ...
              setLOVProperty("WHERE", "IS_PLAN = 'TRUE' AND BELONG_TO_LU = 'HseAccident'").
              setLabel("HSEACCIDENTHANDLERESULTQUOTEID: Quote Id").
...
//              setFunction("QUA_ACCIDENT_API.Get_Contract_No_By_AccNo (:PROJ_NO,:QUOTE_ID)").
              setLabel("HSEACCIDENTHANDLERESULTCONTRACTNO: Contract No").
              setSize(30);
      headblk.addField("CONTRACT_DESC").
              ...
              setLabel("HSEACCIDENTHANDLERESULTCONTRACTDESC: Contract Desc").
              setSize(30);
...
//              setFunction("PROJECT_CONTRACT_API.Get_Secend_Side (:PROJ_NO,QUA_ACCIDENT_API.Get_Contract_No (:PROJ_NO,:QUOTE_ID))").
              setLabel("HSEACCIDENTHANDLERESULTCONSTRUCTORG: Construct Org").
              setSize(30);
      headblk.addField("CONSTRUCT_ORG_DESC").
              ...
              setLabel("HSEACCIDENTHANDLERESULTCONSTRUCTORGEDESC: Construct Org Desc").
              setSize(30);
...
//              setFunction("PROJECT_CONTRACT_API.Get_Third_Side (:PROJ_NO,QUA_ACCIDENT_API.Get_Contract_No (:PROJ_NO,:QUOTE_ID))").
              setLabel("HSEACCIDENTHANDLERESULTSUPERVISIONORG: Supervision Org").
              setSize(30);
      headblk.addField("SUPERVISION_ORG_DESC").
              ...
              setLabel("HSEACCIDENTHANDLERESULTSUPERVISIONORGDESC: Supervision Org Desc").
              setSize(30);
      headblk.addField("SUB_PROJ_NO").
              setReadOnly().  
//              setFunction("QUA_ACCIDENT_API.Get_Sub_Proj_No_By_AccNo(:PROJ_NO,:QUOTE_ID)").
              setLabel("HSEACCIDENTHANDLERESULTSUBPROJNO: Sub Proj No").
              setSize(30);
      headblk.addField("SUB_PROJ_NAME").
              setReadOnly().
              setLabel("HSEACCIDENTHANDLERESULTSUBPROJNAME: Sub Proj Name").
...
//              setFunction("QUA_ACCIDENT_API.Get_Proj_Position_By_AccNo(:PROJ_NO,:QUOTE_ID)").
              setLabel("HSEACCIDENTHANDLERESULTPROJPOSITION: Proj Position").
              setSize(30).
              setMaxLength(100);
      
      headblk.addField("HANDLE_PERSON").             
              setLabel("HSEACCIDENTHANDLERESULTHANDLEPERSON: Handle Person").
              setInsertable().
              setDynamicLOV("PERSON_INFO").
              setSize(30);
      headblk.addField("HANDLE_PERSON_NAME").
              setFunction("PERSON_INFO_API.GET_NAME ( :HANDLE_PERSON)").
              setLabel("HSEACCIDENTHANDLERESULTHANDLEPERSONNAME: Handle Person Name").
              setReadOnly().
              setSize(30);
      mgr.getASPField("HANDLE_PERSON").setValidation("HANDLE_PERSON_NAME");
      headblk.addField("HANDLE_TIME","Date").
              setLabel("HSEACCIDENTHANDLERESULTHANDLETIME: Handle Time").
              setInsertable().
              setSize(30);
      headblk.addField("NOTE").
              setInsertable().
              setLabel("HSEACCIDENTHANDLERESULTNOTE: Note").
              setSize(120).
              setMaxLength(500).
              setHeight(3);
      ...
      headtbl.setTitle("HSEACCIDENTHANDLERESULTTBLHEAD: Hse Accident Handle Plan");
      headtbl.enableRowSelect();
      headtbl.setWrap();
      headlay = headblk.getASPBlockLayout();
      headlay.setDefaultLayoutMode(headlay.MULTIROW_LAYOUT);
      headbar.addCustomCommand("printReport", "HSEACCIDENTHANDLERESULTPRINTREPORT: Print Report...");
   ...
   public void  printReport() throws FndException, UnsupportedEncodingException
  {
   ...
   if (headset.countRows()>0 )
         {   
            ...
            String id = headset.getValue("ID");
             appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=HseAccidentHandleResult.raq&proj_no="+proj_no+"&id="+id
   ...
   {
      return "HSEACCIDENTHANDLERESULTDESC: Hse Accident Handle Result";
   }


   protected String getTitle()
   {
      return "HSEACCIDENTHANDLERESULTTITLE: Hse Accident Handle Result";
   }
