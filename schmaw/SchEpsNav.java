...
public class SchEpsNav extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.schmaw.SchEpsNav");
   ...
   public  SchEpsNav (ASPManager mgr, String page_path)
   {
      super(mgr, page_path);
   }
   ...
   public void okFind()
   {
      ...
      {
         mgr.showAlert("SCHEPANAVNODATA: No data found.");
         headset.clear();
      }
   }
...
//      headblk.defineCommand("GENERAL_PROJECT_API","New__,Modify__,Remove__");
      ...
      headtbl.setTitle("SCHEPSNAV: Sch Eps Nav");
...
//      headtbl.setWrap();
   ...
   public void findTree() throws FndException{
      ...
      callNewWindow("SchEpsTree.page", selected_fields);
   }
   ...
   public void  adjust()
   {
      ...
      {
         src_str    = "SchEpsTree.page";
      }
      else
      {
         project_no    = headset.getValue("PROJ_NO");    
         src_str    = "SchEpsTree.page?PROJ_NO="+project_no;
      }     
   }
   ...
   protected AutoString getContents() throws FndException
   {
      ...
      out.append("<html>\n");
      out.append("<head>");
      out.append(mgr.generateHeadTag("SCHEPSNAV: Sch Eps Nav"));
      out.append("</head>\n");
      out.append("<body ");
      ...
      out.append(mgr.startPresentation("SCHEDULEEPS: Sch Eps"));
      ...
      { 
          ...
          out.append("</iframe>\n");
          out.append("<iframe name =\"ChildMain\" src=\"SchEps.page?PROJ_NO="+mgr.URLEncode(headset.getValue("PROJ_NO"))+"\" width=\"74%\" scrolling=\"auto\" height=\"100%\" scrolling=\"auto\" marginwidth=\"0\" marginheight=\"0\">\n");
          out.append("</iframe>\n");
