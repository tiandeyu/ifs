...
public class SchPlanCheckWork extends ASPPageProvider
{
   ...
   public  SchPlanCheckWork (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void run()
   {
      ...
      String work_no =  mgr.readValue("WORK_NO");
      ...
      if( mgr.commandBarActivated() )
         ...
         okFind();
      else if( !mgr.isEmpty(project_type_id) || !mgr.isEmpty(temp_no) || !mgr.isEmpty(work_no)){
         ctx.setGlobal("PROJ_NO", project_type_id);
         ctx.setGlobal("ID", temp_no);  
         ctx.setGlobal("WORK_NO", work_no);
         okFind();  
      }
...
//      okFind();
   ...
   public void okFind()
   {
      ...
      if (!mgr.isEmpty(work_no)){
         q.addWhereCondition("WORK_NO = ? ");
         q.addParameter("WORK_NO" , work_no);  
      }else{
        q.addWhereCondition("PARENT_ID IS NULL");
      }  
      q.setOrderByClause("WORK_NO");
   ...
   public void  preDefine()
   {
      ...
      sch_logical_relation_blk.addField("ITEM0_WORK_NAME").
                               setFunction("SCH_PLAN_WORK_API.Get_Work_Name (:ITEM0_PROJ_NO,:ITEM0_ID,:ITEM0_REV,:ITEM0_WBS_NO,:ITEM0_WORK_NO)").
                               setInsertable().
    ...
    sch_logical_relation_blk.addField("STATUS").
                             setInsertable().
                             setFunction("SCH_PLAN_WORK_API.Get_Sch_Work_Status (:ITEM0_PROJ_NO,:ITEM0_ID,:ITEM0_REV,:ITEM0_WBS_NO,:ITEM0_WORK_NO)").
      ...
      sch_work_resource_blk.addField("TOTAL_PRICE").
                            setInsertable().
                            setFunction("''").
                            setLabel("SCHWORKRESOURCEPLANQTY: Total Price").
                            setSize(40);
