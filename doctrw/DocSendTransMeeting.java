...
public class DocSendTransMeeting extends DocSendTransAncestor {

   public DocSendTransMeeting(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,MEETING_TYPE,MEETING_TYPE_NAME,ATTACH_TYPE,ATTACH_TYPE_NAME,";
      String fieldGroup2 = "PROJ_NO,PROJ_NAME,SEND_DATE,PAGES,ATTACH_PAGES,RECEIPT,RECEIPT_REQUEST,PRESENTER,ATTACH,MEETING_DATE,MEETING_LOC,HOST_UNIT,ATTEND_UNIT,";
      String fieldGroup3 = "SEND_UNIT_NO,SEND_UNIT_NAME,DRAFT_DEPT_NO,DRAFT_DEPT_NAME,";
      String fieldGroup4 = "CREATE_PERSON,CREATE_PERSON_NAME,CREATE_DATE,CREATE_OPINION," +
            "AUTH_PERSON,AUTH_PERSON_NAME,AUTH_DATE,AUTH_OPINION,APPROVE_PERSON,APPROVE_PERSON_NAME,APPROVE_DATE,APPROVE_OPINION,";
      String fieldGroup5 = "MAIN_SEND_UNIT_NO,MAIN_SEND_UNIT_NAME,CO_SEND_UNIT_NO,INNER_SEND,INNER_SEND_NAME,";
      headlay.setFieldOrder(fieldGroup1 + fieldGroup2 + fieldGroup3 + fieldGroup4 + fieldGroup5);
      
      mgr.getASPField("TRANSFER_NO").setLabel("DOCSENDTRANSMEETINGINNERMEETINGCODE: Inner Meeting Code");
      
      headlay.setDataSpan("REV_TITLE", 5);
//      headlay.setDataSpan("MEETING_LOC", 5);
      headlay.setDataSpan("HOST_UNIT", 5);
      headlay.setDataSpan("ATTEND_UNIT", 5);
...
//            "REV_TITLE,DOC_CODE,TRANSFER_NO,MEETING_TYPE,MEETING_TYPE_NAME,ATTACH_TYPE,ATTACH_TYPE_NAME,",false,true);
//      headlay.defineGroup(mgr.translate("DOCSENDTRANSSENDTRANSIDGROUPFILEATTRIBUTES: Document Title Attributes"),
//            "PROJ_NO,PROJ_NAME,SEND_DATE,PAGES,ATTACH_PAGES,RECEIPT,RECEIPT_REQUEST,PRESENTER,ATTACH,MEETING_DATE,MEETING_LOC,HOST_UNIT,ATTEND_UNIT," +
//            "SEND_UNIT_NO,SEND_UNIT_NAME,DRAFT_DEPT_NO,DRAFT_DEPT_NAME," +
...
//            +"SUB_CLASS,ATTACH_TYPE,ATTACH_TYPE_NAME,",true,false);
   }
...
//      mgr.getASPField("VIEW_FILE").unsetHidden();
      ...
      mgr.getASPField("PRESENTER").unsetHidden();
      mgr.getASPField("ATTACH").unsetHidden();
      mgr.getASPField("MEETING_DATE").unsetHidden();
      mgr.getASPField("MEETING_LOC").unsetHidden();
      mgr.getASPField("HOST_UNIT").unsetHidden();
      mgr.getASPField("ATTEND_UNIT").unsetHidden();
...
//       mgr.getASPField("INNER_SEND_NAME").unsetHidden();
   ...
   protected String getTitle() {
       return  "DOCSENDTRANSTITLEMEETING: Doc Send Trans Meeting";
   }
