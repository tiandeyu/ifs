...
public class DocIssueSendFaxExch extends DocIssueSendFax {

   public DocIssueSendFaxExch(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
...
//
   ...
   protected String getTitle() {
       return "DOCISSUESENDFAXTITLEEXCH: Exchange Send - Fax";
   }
