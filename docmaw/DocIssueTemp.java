...
public class DocIssueTemp extends DocIssueAncestor {

   public DocIssueTemp(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,HEAD_VIEW_FILE,PROJ_NO,PROJ_NAME,SUB_CLASS,SUB_CLASS_NAME,SEND_UNIT_NO,SEND_UNIT_NAME,SEND_DEPT,SEND_DEPT_DESC,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,USER_CREATED,USER_CREATED_NAME,DT_CRE";
   ...
   protected String getTitle() {
       return "DOCISSUETEMPTITLE: Project Temp";
   }
