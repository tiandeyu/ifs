 ...
 *
 */
public class DocTitleSendFax extends DocTitleAncestor {

   public DocTitleSendFax(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
...
//      headlay.setDataSpan("SEND_UNIT_NO", 5);
   ...
   protected String getTitle() {
       return "DOCTITLESENDFAXTITLE: Overview - Project Send - Fax";
   }
