...
public class DocIssueConstruct extends DocIssueAncestor {

   public DocIssueConstruct(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      mgr.getASPField("DOC_CODE").setLabel("DOCISSUECONSTRUCTDOCCODE: Doc Code");
      mgr.getASPField("TRANSFER_NO").setLabel("DOCISSUECONSTRUCTTRANSFERNO: Transfer No");
      mgr.getASPField("DOC_LOC_NO").setLabel("DOCISSUECONSTRUCTDOCLOCNO: Doc Loc No");
      
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,SUB_CLASS,SUB_CLASS_NAME,STATE,HEAD_VIEW_FILE,DOC_STATE,";
      ...
      String fieldGroup3 = "PAGES,DOC_REV,SEND_UNIT_NO,SEND_UNIT_NAME,SEND_DEPT,SEND_DEPT_DESC,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,SEND_DATE,RECEIVE_UNIT_NO,RECEIVE_UNIT_NAME,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
...
//
   ...
   protected String getTitle() {
       return "DOCISSUECONSTRUCTIONTITLE: Project Construction";
   }
