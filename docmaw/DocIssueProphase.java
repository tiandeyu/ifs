...
public class DocIssueProphase extends DocIssueAncestor {

   public DocIssueProphase(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   @Override
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,TRANSLATE_TITLE,DOC_CODE,SUB_CLASS,SUB_CLASS_NAME,INNER_DOC_CODE,DOC_STATE,STATE,HEAD_VIEW_FILE,";
      String fieldGroup2 = "PROJ_NO,PROJ_NAME,MACH_GRP_NO,MACH_GRP_DESC,SPECIALTY_NO,SPECIALTY_DESC,DOC_LOC_NO,WBS_NO,SEC_LEVEL,LEVEL_NAME,PAGES,DOC_REV,SEND_UNIT_NO,SEND_UNIT_NAME,TRANSFER_NO,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
   ...
   protected String getTitle() {
       return "DOCISSUEPROPHASETITLE: Project Prophase";
   }
