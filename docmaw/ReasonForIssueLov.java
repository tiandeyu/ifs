...
public class ReasonForIssueLov extends ASPPageProvider
{
   //===============================================================
   // Static constants 
   //===============================================================
   public static boolean DEBUG = Util.isDebugEnabled("ifs.docmaw.ReasonForIssueLov");
   ...
   // Construction 
   //===============================================================
   public ReasonForIssueLov(ASPManager mgr, String page_path)
   { 
      super(mgr,page_path);
   }
   ...
   public void  preDefine()
   {
      ...
      blk = mgr.newASPBlock("REASON_FOR_ISSUE");      
      
      blk.setView("DOC_CLASS_REASON_FOR_ISSUE_LOV");
      ...
      f = blk.addField( "REASON_FOR_ISSUE" );
      f.setLabel("DOCMAWREASONFORISSUELOVREASON: Reason For Issue");
      f.setSize(10);
      f.setMaxLength(6);
   
      f = blk.addField( "DESCRIPTION" );
      f.setLabel("DOCMAWREASONFORISSUELOVDESC: Reason Description");
      f.setSize(40);
      f.setMaxLength(4000);

      tbl = mgr.newASPTable(blk);
      tbl.setKey("REASON_FOR_ISSUE"); 
   ...
   public void  okFind(int skipRows )
   {
      ...
      q.setSelectList("REASON_FOR_ISSUE,DESCRIPTION");
      ...
      if (rowset.countRows() == 0)
         mgr.showAlert(mgr.translate("DOCMAWREASONFORISSUELOVNODATA: No data found."));
   }
   ...
   {      
      ...
      appendToHTML(mgr.translate("DOCMAWREASONFORISSUELOVTITLE: List of Reasons For Issue"));
      ...
      if (defined)
      {
         if (lay.isMultirowLayout())
         {
            ...
            if (!lay.isFindLayout() && "true".equals(mgr.readValue("MULTICHOICE")))
            {
               ...
               appendToHTML("       <td width=\"10\"></td>");  
               appendToHTML("       <td >"+fmt.drawReadLabel(mgr.translate("DOCMAWREASONFORISSUELOVSELECT: Select the Reason(s) For Issue to be inserted. "))+"</td>\n");               
               appendToHTML("       <td align = right>"+fmt.drawButton("OK"," " + mgr.translate("DOCMAWREASONFORISSUELOVOK: OK" + " "),"OnClick=ok() align=left")+"</td>\n");
