 ...
 *
 */
public class DocTitleSendMeeting extends DocTitleAncestor {

   public DocTitleSendMeeting(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,ROWSTATE,MEETING_TYPE,MEETING_TYPE_NAME,PURPOSE_NAME,VIEW_FILE,ATTACH_TYPE,ATTACH_TYPE_NAME,";
...
//      headlay.setDataSpan("SEND_UNIT_NO", 5);
   ...
   protected String getTitle() {
       return "DOCTITLESENDMEETINGTITLE: Overview - Project Send - Meeting";
   }
