...
public class DocTitleDesign extends DocTitleAncestor {

   public DocTitleDesign(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() { 
      ...
      mgr.getASPField("DOC_CODE").setLabel("DOCTITLEDESIGNDOCCODE: Doc Code");
      mgr.getASPField("TRANSFER_NO").setLabel("DOCTITLEDESIGNTRANSFERNO: Transfer No");
      mgr.getASPField("REV_TITLE").setLabel("DOCTITLEDESIGNREVTITLE: Rev Title");
      
      mgr.getASPField("FIRST_REVISION").setMandatory();
      
      String fieldGroup1 = "REV_TITLE,TRANSLATE_TITLE,DOC_CODE,INNER_DOC_CODE,ROWSTATE,DOC_STATE,FIRST_REVISION,VIEW_FILE,CHECK_IN_FILE,";
      ...
      String fieldGroup3 = "COPIES,PAGES,BOOKLET_NO,BOOKLET_NAME,PAGE_SIZE,SIZE_NAME,SEC_LEVEL,LEVEL_NAME,SEND_UNIT_NO,SEND_UNIT_NAME,TRANSFER_NO,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
...
//            "COPIES,PAGES,BOOKLET_NO,BOOKLET_NAME,PAGE_SIZE,SIZE_NAME,SEC_LEVEL,LEVEL_NAME,SEND_UNIT_NO,SEND_UNIT_NAME,TRANSFER_NO,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,USER_CREATED,USER_CREATED_NAME,DT_CRE," +
...
//            "ORIG_DOC_REV,REPL_BY_DOC_CLASS,REPL_BY_DOC_NO,TITLE_REV,TITLE_REV_NOTE,SEND_DATE,EMERGENCY,EMERGENCY_DATE,STATE,PROJECT_NO,ZONE_NO,FROM_DOC_CLASS,FROM_DOC_NO,FROM_DOC_SHEET,FROM_DOC_REV",true,false);
   ...
   protected String getTitle() {
       return "DOCTITLEDESIGNTITLE: Overview - Project Design";
   }
