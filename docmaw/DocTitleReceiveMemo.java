 ...
 *
 */
public class DocTitleReceiveMemo extends DocTitleAncestor {

   public DocTitleReceiveMemo(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,ROWSTATE,VIEW_FILE,INNER_DOC_CODE,";
      ...
      headlay.setDataSpan("ROWSTATE", 5);
...
//         mgr.getASPField("PURPOSE_NAME").unsetHidden();
   ...
   protected String getTitle() {
       return "DOCTITLERECEIVEMEMOTITLE: Overview - Project Receive - Memo";
   }
