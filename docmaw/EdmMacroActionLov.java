...
*  Nisilk      : 2003-01-30  - Created. Lov to retrive the Action 
...
public class EdmMacroActionLov extends ASPPageProvider
{
	...
	// Construction 
	//===============================================================
	public EdmMacroActionLov(ASPManager mgr, String page_path)
	{
		super(mgr,page_path);
	}
	...
	{
		EdmMacroActionLov page = (EdmMacroActionLov)(super.clone(obj));
	...
	public void  preDefine()
	{
		...
		tbl.setTitle(mgr.translate("EDMMACROACTION: List of Actions"));
		tbl.setKey("ACTION");              
		defineLOV(); 
