 ...
 *
 */
public class DocTitleReceiveFax extends DocTitleAncestor {

   public DocTitleReceiveFax(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected String getCurrentPageSubDocClass(){
      return DocmawConstants.PROJ_RECEIVE_FAX;
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,ROWSTATE,PURPOSE_NO,PURPOSE_NAME,VIEW_FILE,CHECK_IN_FILE,INNER_DOC_CODE,";
      String fieldGroup2 = "PROJ_NO,PROJ_NAME,RECEIVE_DATE,PAGES,ATTACH_PAGES,RECEIPT,RECEIPT_REQUEST,SEND_UNIT_NO,SEND_UNIT_NAME,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,RECEIVE_UNIT_NO,RECEIVE_UNIT_NAME,CO_SEND,INNER_SEND,EXTAND_DOC_CODE1,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
   ...
   protected String getTitle() {
       return "DOCTITLERECEIVEFAXTITLE: Overview - Project Receive - Fax";
   }
