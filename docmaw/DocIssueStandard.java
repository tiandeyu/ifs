...
public class DocIssueStandard extends DocIssueAncestor {

   public DocIssueStandard(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      mgr.getASPField("DOC_CODE").setLabel("DOCISSUESTANDARDDOCCODE: Doc Code");
      mgr.getASPField("TRANSFER_NO").setLabel("DOCISSUESTANDARDTRANSFERNO: Transfer No");
      mgr.getASPField("REV_TITLE").setLabel("DOCISSUESTANDARDREVTITLE: Rev Title");
      
      
      String fieldGroup1 = "REV_TITLE,TRANSLATE_TITLE,DOC_CODE,SUB_CLASS,SUB_CLASS_NAME,STATE,HEAD_VIEW_FILE,";
      String fieldGroup2 = "PROJ_NO,PROJ_NAME,SPECIALTY_NO,SPECIALTY_DESC,SEC_LEVEL,LEVEL_NAME,PAGES,DOC_REV,SEND_UNIT_NO,SEND_UNIT_NAME,TRANSFER_NO,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
   ...
   protected String getTitle() {
       return "DOCISSUESTANDARDTITLE: Project Standard";
   }
