...
public class DocIssueSendFax extends DocIssueSendAncestor {

   public DocIssueSendFax(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
...
//      headlay.setDataSpan("SEND_UNIT_NO", 5);
   ...
   protected String getTitle() {
       return "DOCISSUESENDFAXTITLE:  Project Send - Fax";
   }
