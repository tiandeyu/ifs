...
public class DocIssueReceiveFax extends DocIssueReceiveAncestor {

   public DocIssueReceiveFax(ASPManager mgr, String page_path) {
      super(mgr, page_path);
   }
   ...
   protected void customizeHeadlay() {
      ...
      String fieldGroup1 = "REV_TITLE,DOC_CODE,TRANSFER_NO,STATE,PURPOSE_NO,PURPOSE_NAME,HEAD_VIEW_FILE,INNER_DOC_CODE,";
      String fieldGroup2 = "PROJ_NO,PROJ_NAME,SEND_DATE,RECEIVE_DATE,PAGES,ATTACH_PAGES,RECEIPT,RECEIPT_REQUEST,SEND_UNIT_NO,SEND_UNIT_NAME,SIGN_PERSON,SIGN_PERSON_NAME,COMPLETE_DATE,RECEIVE_UNIT_NO,RECEIVE_UNIT_NAME,CO_SEND,INNER_SEND,EXTAND_DOC_CODE1,USER_CREATED,USER_CREATED_NAME,DT_CRE,";
   ...
   protected String getTitle() {
       return "DOCISSUERECEIVEFAXTITLE: Project Receive - Fax";
   }
