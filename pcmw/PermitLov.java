...
public class PermitLov extends ASPPageProvider
{
	//===============================================================
	// Static constants 
	//===============================================================
	...
	// Construction 
	//===============================================================
	public PermitLov(ASPManager mgr, String page_path)
	{
		super(mgr,page_path);
	}
	...
	public void search()
	{
		...
		trans.clear(); 
		cmd = trans.addCustomCommand("ENUMSTATE","PERMIT_API.Enumerate_States__");
...
//===============================================================
	...
	protected void printContents() throws FndException
	{
		...
		appendToHTML(tbl.populateLov());	//XSS_Safe AMNILK 20070727	
	}
