 ...
 * ----------------------------------------------------------------------------
 * File        : TransferMaintTransactionDlg.java
 * Description : Transfer Maintenance Transactions.
 * Notes       :
 * ----------------------------------------------------------------------------
 *
 ...
 * SHAFLK  081119  Bug 77074, Redesigned the page.
...
public class TransferMaintTransactionDlg extends ASPPageProvider
{
    //===============================================================
    // Static constants 
    //===============================================================
    public static boolean DEBUG = Util.isDebugEnabled("ifs.pcmw.TransferMaintTransactionDlg");
    ...
    // Construction 
    //===============================================================
    public TransferMaintTransactionDlg(ASPManager mgr, String page_path)
    {
        super(mgr,page_path);
    }
...
//-----------------------------------------------------------------------------
    ...
    public void  get_contract()
    {
        ...
        cmd.addParameter("FUNCTION_GROUP","V");
    ...
    public void  submit()
    {
        ASPManager mgr = getASPManager();
        trans.clear();
        cmd = trans.addCustomCommand("MM2","Pcm_Accounting_API.Transfer_To_Finance");
...
public void preDefine()
{
        ...
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGCOMPANY: Company");                                                      
        f.setInsertable(); 
        f.setMandatory();                                                                         
        ...
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGCONTRACT: Site");                                                     
        f.setInsertable();  
        ...
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGUSER_GROUP: User Group");                                                      
        f.setInsertable(); 
        f.setMandatory();                                                                         
        ...
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGVOUCHER_TYPE: Voucher Type");                                                     
        f.setInsertable(); 
	...
	f.setHidden();
        ...
        headlay.defineGroup(mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGGRPLABEL1: Parameters"),"COMPANY,CONTRACT,USER_GROUP,VOUCHER_TYPE",true,true);
        headlay.showBottomLine(false);

        headblk2 = mgr.newASPBlock("HEAD2");

        f = headblk2.addField("FROM_DATE", "Date");                                                 
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGDATEFROM: From Date");                                                     
        f.setFunction("''");                                                       
        f.setInsertable();                                                                 
        f.setSize(25);   

        f = headblk2.addField("DATE_APPLIED", "Date");                                                 
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGDATETO: To Date");                                                     
        f.setFunction("''");                                                       
        f.setInsertable();                                                                 
        f.setSize(25);

        f = headblk2.addField("VOUCHER_DATE", "Date");                                                 
        f.setLabel("PCMWTRANSFERMAINTTRANSACTIONDLGVOUCHER_DATE: Voucher Date");                                                     
        f.setFunction("''");                                                       
        f.setInsertable();                                                                 
        f.setSize(25);
        ...
        headlay2.defineGroup(mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGGRPLABEL2: Date Selection"),"FROM_DATE,DATE_APPLIED,VOUCHER_DATE",true,true);
...
//===============================================================
        protected String getDescription()
        {
            ...
            return mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGTITLE1: Transfer Time Transactions");
        }
	...
	protected void printContents() throws FndException
	{
		...
		appendToHTML(fmt.drawRadio("PCMWTRANSFERMAINTTRANSACTIONDLGRADIO1: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One Voucher Per Date","OPTION","0",true," OnClick='validateOption(0)'"));
		appendToHTML("</td><td width=10>&nbsp</td>\n");
		appendToHTML("	<tr>\n");
		appendToHTML("		<td  nowrap  valign=top><img src=\"../common/images/table_empty_image.gif\" width=\"1\" height=\"4\"><br><b>");
		appendToHTML(fmt.drawRadio("PCMWTRANSFERMAINTTRANSACTIONDLGRADIO2: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One Voucher for All Dates", "OPTION","1",false,"OnClick='validateOption(1)'"));
		appendToHTML("</td><td width=10>&nbsp</td>\n");
		appendToHTML("</table>	\n");
		...
		appendToHTML("</table>\n");
                ...
                printNewLine();
                printSpaces(1);
                printSubmitButton("SUBMIT",mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGOKBUTTON:    OK    "), "");
                printSpaces(1);
                printSubmitButton("CANCEL",mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGCANCELBUTTON:  Cancel "), "");
                printSpaces(1);
                printSubmitButton("DEFAULTS",mgr.translate("PCMWTRANSFERMAINTTRANSACTIONDLGDEFAULTSBUTTON:  Get Defaults "), "");
