...
* ----------------------------------------------------------------------------
*  File        : ModuleIsoTypDlg.java 
*  Created     : NEKOLK AMUT 115: Isolation and Permits.
*  Modified    :
*  NEKOLK  040705 AMUT115 modified submit().
...
public class ModuleIsoTypDlg extends ASPPageProvider
{
	//===============================================================
	// Static constants 
	//===============================================================
	public static boolean DEBUG = Util.isDebugEnabled("ifs.pcmw.ModuleIsoTypDlg");
	...
	// Construction 
	//===============================================================
	public ModuleIsoTypDlg(ASPManager mgr, String page_path)
	{
		super(mgr,page_path);
	}
...
//-----------------------------------------------------------------------------
	...
	public void  submit()
	{
		...
		CurrDelim = mgr.readValue("ISOLATION_TYPE");

                if (!mgr.isEmpty(CurrDelim))
		{
			cmd = trans.addCustomCommand("NEWDLO","Delimitation_Order_Utility_API.Create_Dlo_From_Permit_Type");
			cmd.addParameter("DELIMITATION_ORDER_NO");
			cmd.addParameter("ISOLATION_TYPE",mgr.readValue("ISOLATION_TYPE"));
			cmd.addParameter("PERMIT_TYPE_ID",mgr.readValue("PERMIT_TYPE_ID"));
                        cmd.addParameter("ISODESCRIPTION",mgr.readValue("ISODESCRIPTION"));
    ...
    public void  preDefine()
		...
		f.setSize(22);
                f.setLOV("ConnPermitIsolationLov.page","PERMIT_TYPE_ID",600,450);
		f.setFunction("''");
		f.setLabel("MODULEISOTYPDLGISOLATIONTYPE: Isolation Type");
                f.setMandatory();

		f = headblk.addField("ISODESCRIPTION");
                f.setLabel("ISODESC: Description");
		f.setSize(22);
		f.setFunction("''");
                f.setMandatory();
		...
		headlay.setEditable();
		headlay.defineGroup(mgr.translate("PCMWMODULEDLGDELI: Isolation"),"ISOLATION_TYPE,ISODESCRIPTION",true,true);
	}
...
//===============================================================
	...
	{
		return "PCMWMODULEISODLGTYPTITLE: Create Isolation Order from Isolation Type";
	}
