...
public class WorkOrderCostAnalysisSM extends ASPPageProvider {
    //===============================================================
    // Static constants 
    //===============================================================
    public static boolean DEBUG = Util.isDebugEnabled("ifs.pcmw.WorkOrderCostAnalysisSM");
    ...
    // Construction 
    //===============================================================
    public WorkOrderCostAnalysisSM(ASPManager mgr, String page_path)
    {
        super(mgr,page_path);
    }
...
//=============================================================================
    ...
    public void  preDefine()
    {
        ...
        f.setLOVProperty("TITLE",mgr.translate("PCMWWORKORDERCOSTANALYSISSMEXEDE: List Of Executing Dept"));
        f.setMandatory();
        f.setLabel("PCMWWORKORDERCOSTANALYSISSMORGCODE: Executing Dept");
        f.setUpperCase();
        f.setReadOnly();
        f.setHilite();
        f.setDefaultNotVisible();
	...
	//Bug 87766, End
        ...
        headlay.defineGroup("","WO_NO,CONTRACT,WO_STATUS_ID,ERR_DESCR,ORG_CODE,WORK_TYPE_ID,CUSTOMER_NO,CUSTOMERNAME,CONTRACT_ID,LINE_NO,AGREEMENT_ID,AUTHORIZE_CODE,CBHASCONNECTIONS",false,true);
    ...
    public void  adjust()
    {
        ...
        if (headlay.isMultirowLayout()) {
            ...
            mgr.getASPField("CBHASCONNECTIONS").setHidden();
        }
    ...
    {
        return "Work Order Cost/Revenue Analysis SM";
    }

    protected String getTitle()
    {
        return "PCMWWORKORDERTITLE1: Work Order Cost/Revenue Analysis SM";
    }
    ...
    { 
        ...
        out.append("<html>\n");
        out.append("<head>");
        out.append(mgr.generateHeadTag("PCMWWORKORDERTITLE1: Work Order Cost/Revenue Analysis SM"));
        ...
        out.append(">\n");
        out.append(mgr.startPresentation("PCMWWORKORDERTITLE1: Work Order Cost/Revenue Analysis SM"));
