...
* ----------------------------------------------------------------------------
*  File        : ConnectOperationsDlg.java 
*  Created     : THWILK  050512  Created
*  Modified    :
*  THWILK  050519  Modified printContents() and run().
...
public class ConnectOperationsDlg extends ASPPageProvider
{
	//===============================================================
	// Static constants 
	//===============================================================
	public static boolean DEBUG = Util.isDebugEnabled("ifs.pcmw.ConnectOperationsDlg");
	...
	// Construction 
	//===============================================================
	public ConnectOperationsDlg(ASPManager mgr, String page_path)
	{
		super(mgr,page_path);
	}
	...
	public void run() 
	{
		...
		if (mgr.commandBarActivated())
			...
			validate();
                else if ((!mgr.isEmpty(mgr.getQueryStringValue("WO_NO"))) && (!mgr.isEmpty(mgr.getQueryStringValue("JOB_ID"))))
               {
                       ...
                       calling_url= calling_url+"?&WO_NO="+woNo;
               }
...
//-----------------------------------------------------------------------------
	...
	{
                ASPManager mgr = getASPManager();
                cmd = trans.addCustomCommand("CONOPERATION","Work_Order_Role_API.Connect_Job");
...
//-----------------------------------------------------------------------------
	...
	public void adjust()
	{
		...
		mgr.getASPField("ROW_NO").setDynamicLOV("WORK_ORDER_ROLE_OP",600,445);
		mgr.getASPField("ROW_NO").setLOVProperty("WHERE","WO_NO= '" + woNo + "' AND JOB_ID IS NULL");  
	}
...
//===============================================================
	...
	{
		return "PCMWCONOPERATIONSDLGTITLE: Connect an Existing Operation";
	}
