...
public class ConProjConnectionListFreeReply extends HzASPPageProviderWf {

   public ConProjConnectionListFreeReply(ASPManager mgr, String pagePath) {
      super(mgr, pagePath);
   }
      // TODO Auto-generated constructor stub
      public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConProjConnectionListFreeReply");
      ...
      public void okFind()
      {
         ...
         q.includeMeta("ALL");
         q.addWhereCondition("CON_LIST_TYPE_DB = 'FREEREPLY'");
      ...
      public void newRow()
      {
         ...
         data.setFieldItem("CON_LIST_TYPE_DB", "FREEREPLY");
      ...
      public void  preDefine()
      {
         ...
         headblk.addField("GENERAL_PROJECT_PROJ_DESC").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYGENERALPROJECTPROJDESC: General Project Proj Desc").
                 setSize(30).
                 setReadOnly();
...
//                 setLOVProperty("WHERE", "SCHEDULE = 'TRUE'").
         ...
         headblk.addField("CONTRACT_NAME").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYCONTRACTNNAME: Contract Name").
                 setSize(30).
                 setReadOnly();
         ...
         headblk.addField("LIST_NO").
                 setInsertable().
                 setMandatory().
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYLISTNO: List No").
                 setSize(30);
         ...
         headblk.addField("MAJOR_NAME").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYMAJORNAME: Major Name").
                 setSize(30);
         ...
         headblk.addField("SUB_PROJ_NO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYSUBPROJNO: Sub Proj No").
                 setSize(30);

         headblk.addField("SUB_PROJ_DESC").
                 setFunction("CON_PROJ_CONSTRUCTION_MAN_API.Get_Node_Name ( :PROJ_NO,:SUB_PROJ_NO)").
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYSUBPROJDESC: SUB PROJ DESC").
                 setReadOnly().
                 setSize(30);
         ...
         headblk.addField("STATUS").
                 setHidden().
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYSTATUS: Status").
                 setSize(30);
         headblk.addField("STATUS_DESC").
                 setReadOnly().
                 setFunction("FLOW_STATUS_API.Get_Status_Desc (:STATUS)").
                 setLabel("CONPROJCONNECTIONLISTFREEREPLYSTATUSDESC: Status Desc").
                 setSize(30);
         ...
         headbar.addCustomCommand("printReport", "CONPROJCONNECTIONLISTFREEREPLYREPORT: Print Proj Connection List Free Reply Report...");//TODO
    ...
    //Report  Function
       ...
       if (headset.countRows()>0 )
             {   
                ...
                String id = headset.getValue("ID");
                 appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptConProjConnectionListFreeReply.raq&proj_no="+proj_no+"&id="+id
      ...
      {
         return "CONPROJCONNECTIONLISTFREEREPLYDESC: Con Proj Connection List Free Reply";
      }
