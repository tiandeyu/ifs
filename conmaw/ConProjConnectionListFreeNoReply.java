...
public class ConProjConnectionListFreeNoReply extends HzASPPageProviderWf {

   public ConProjConnectionListFreeNoReply(ASPManager mgr, String pagePath) {
      super(mgr, pagePath);
   }
      // TODO Auto-generated constructor stub
      public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConProjConnectionListFreeNoReply");
      ...
      public void okFind()
      {
         ...
         q.includeMeta("ALL");
         q.addWhereCondition("CON_LIST_TYPE_DB = 'FREENOREPLY'");
      ...
      public void newRow()
      {
         ...
         data.setFieldItem("CON_LIST_TYPE_DB", "FREENOREPLY");
      ...
      public void  preDefine()
      {
         ...
         headblk.addField("PROJ_NO").
                 ...
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYPROJNO: Proj No").
                 setSize(30);
         headblk.addField("GENERAL_PROJECT_PROJ_DESC").
                 setFunction("GENERAL_PROJECT_API.GET_PROJ_DESC (:PROJ_NO)").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYGENERALPROJECTPROJDESC: General Project Proj Desc").
                 setSize(30).
                 setReadOnly();
...
//                 setLOVProperty("WHERE", "SCHEDULE = 'TRUE'").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCONTRACTID: Contract Id").
                 setSize(30);
         headblk.addField("CONTRACT_NAME").
                 setFunction("PROJECT_CONTRACT_API.Get_Contract_Desc (:PROJ_NO,:CONTRACT_ID)").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCONTRACTNNAME: Contract Name").
                 setSize(30).
                 setReadOnly();
         ...
         headblk.addField("LIST_NO").
                 setInsertable().
                 setMandatory().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYLISTNO: List No").
                 setSize(30);
         headblk.addField("LIST_NAME").
                 setInsertable().
                 setMandatory().
                 setWfProperties().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYLISTNAME: List Name").
                 setSize(30);
         headblk.addField("IS_REPLY").
                 setHidden().
                 setCheckBox("0,1").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYISREPLY: Is Reply").
                 setSize(30);
         headblk.addField("GENSET").
                 setInsertable().
                 setMandatory().
                 setDynamicLOV("CON_GENSET_DATA","PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYGENSET: Genset").
                 setSize(30).
         ...
         headblk.addField("GENSET_NO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYGENSETNO: Genset No").
                 setSize(30);
         headblk.addField("GENSET_NAME").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYGENSETNAME: Genset Name").
                 setSize(30);
         headblk.addField("MAJOR").
                 setInsertable().
                 setMandatory().
                 setDynamicLOV("CON_MAJOR_DATA","PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYMAHOR: Major").
                 setSize(30);
         headblk.addField("MAJOR_NAME").
                 setReadOnly().
                 setFunction("CON_MAJOR_DATA_API.GET_MAJOR_NAME ( :PROJ_NO,:MAJOR)").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYMAJORNAME: Major Name").
                 setSize(30);
         ...
         headblk.addField("SEND_TO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYSENDTO: Send To").
                 setSize(30);
         headblk.addField("SEND_TO_NAME").
                 setFunction("GENERAL_ORGANIZATION_API.Get_Org_Desc( :SEND_TO)").
                 setReadOnly().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYSENDTONAME: Send To Name").
                 setSize(30);
         mgr.getASPField("SEND_TO").setValidation("SEND_TO_NAME");
         
         headblk.addField("COPY_TO").
                 setReadOnly().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCOPYTO: Copy To").
                 setSize(30);
         headblk.addField("COPY_TO_PERSON").
                 setHidden().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCOPYTOPERSON: Copy To Person").
                 setSize(30);
         
         headblk.addField("ID").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYID: Id").
                 setSize(200);
         ...
         headblk.addField("START_ORG").
                 setInsertable().
                 setDynamicLOV("GENERAL_ORGANIZATION_LOV", "PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYSTARTORG: Start Org").
                 setSize(30);
         ...
         headblk.addField("CREATE_TIME","Date").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCREATETIME: Create Time").
                 setSize(30);
         headblk.addField("REPLY_LIST_NO").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYREPLYLISTNO: Reply List No").
                 setSize(30);
         headblk.addField("BOOK_NO").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYBOOKNO: Book No").
                 setSize(30);
         headblk.addField("BOOK_NAME").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYBOOKNAME: Book Name").
                 setSize(30);
         headblk.addField("ESTIMATE_COST").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYESTIMATECOST: Estimate Cost").
                 setSize(30);
         headblk.addField("ACTUAL_COST").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYACTUALCOST: Actual Cost").
                 setSize(30);
         headblk.addField("CONTRACT_NO").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCONTRACTNO: Contract No").
                 setSize(30);       
         headblk.addField("NOTE").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYNOTE: Note").
                 setSize(2000);
         headblk.addField("STATUS").
                 setHidden().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYSTATUS: Status").
                 setSize(30);
         headblk.addField("STATUS_DESC").
                 setReadOnly().
                 setFunction("FLOW_STATUS_API.Get_Status_Desc (:STATUS)").
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYSTATUSDESC: Status Desc").
                 setSize(30);
         headblk.addField("CONTENT").
                 setInsertable().
                 setLabel("CONPROJCONNECTIONLISTFREENOREPLYCONTENT: Content").
                 setSize(130).
                 setHeight(5);
         ...
         headbar.addCustomCommand("printReport", "CONPROJCONNECTIONLISTFREENOREPLYREPORT: Print Proj Connection List Free NoReply Report...");//TODO
    ...
    //Report  Function
       ...
       if (headset.countRows()>0 )
             {   
                ...
                String id = headset.getValue("ID");
                 appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptConProjConnectionListFreeNoReply.raq&proj_no="+proj_no+"&id="+id
      ...
      {
         return "CONPROJCONNECTIONLISTFREENOREPLYDESC: Con Proj Connection List Free No Reply";
      }
