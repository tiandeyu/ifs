...
public class ConProjConnectionListInnerReply extends HzASPPageProviderWf {

   public ConProjConnectionListInnerReply(ASPManager mgr, String pagePath) {
      super(mgr, pagePath);
   }
      // TODO Auto-generated constructor stub
      public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConProjConnectionListInnerReply");
      ...
      public void okFind()
      {
         ...
         q.includeMeta("ALL");
         q.addWhereCondition("CON_LIST_TYPE_DB = 'INNERREPLY'");
      ...
      public void newRow()
      {
         ...
         data.setFieldItem("CON_LIST_TYPE_DB", "INNERREPLY");
         data.setFieldItem("IS_REPLY", "1");
      ...
      public void  preDefine()
      {
         ...
         headblk.addField("PROJ_NO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYPROJNO: Proj No").
                 setSize(30);
         headblk.addField("GENERAL_PROJECT_PROJ_DESC").
                 setFunction("GENERAL_PROJECT_API.GET_PROJ_DESC (:PROJ_NO)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYGENERALPROJECTPROJDESC: General Project Proj Desc").
                 setSize(30).
                 setReadOnly();
...
//                 setLOVProperty("WHERE", "SCHEDULE = 'TRUE'").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCONTRACTID: Contract Id").
                 setSize(30);
         headblk.addField("CONTRACT_NAME").
                 setInsertable().
                 setFunction("PROJECT_CONTRACT_API.Get_Contract_Desc (:PROJ_NO,:CONTRACT_ID)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCONTRACTNNAME: Contract Name").
                 setSize(30);
         ...
         headblk.addField("LIST_NO").
                 setInsertable().
                 setMandatory().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYLISTNO: List No").
                 setSize(30);
         headblk.addField("LIST_NAME").
                 setInsertable().
                 setMandatory().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYLISTNAME: List Name").
                 setSize(30);
         headblk.addField("MAJOR").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYMAHOR: Major").
                 setSize(30);
         headblk.addField("MAJOR_NAME").
                 setReadOnly().
                 setFunction("CON_MAJOR_DATA_API.GET_MAJOR_NAME ( :PROJ_NO,:MAJOR)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYMAJORNAME: Major Name").
                 setSize(30);
         ...
         headblk.addField("GENSET").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYGENSET: Genset").
                 setSize(30).
         ...
         headblk.addField("GENSET_NO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYGENSETNO: Genset No").
                 setSize(30);
         headblk.addField("GENSET_NAME").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYGENSETNAME: Genset Name").
                 setSize(30);
         ...
         headblk.addField("SEND_TO").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSENDTO: Send To").
                 setSize(30);
         headblk.addField("SEND_TO_NAME").
                 setFunction("GENERAL_ORGANIZATION_API.Get_Org_Desc( :SEND_TO)").
                 setReadOnly().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSENDTONAME: Send To Name").
                 setSize(30);
         ...
         headblk.addField("COPY_TO").
                 setReadOnly().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCOPYTO: Copy To").
                 setSize(30);
         headblk.addField("COPY_TO_PERSON").
                 setHidden().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCOPYTOPERSON: Copy To Person").
                 setSize(30);
         ...
         headblk.addField("CREATE_PERSON").
                 ...
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCREATEPERSON: Create Person").
                 setSize(30).
                 setCustomValidation("CREATE_PERSON", "CREATE_PERSON_NAME,START_ORG,START_ORG_NAME");
         headblk.addField("CREATE_PERSON_NAME").
                 setFunction("PERSON_INFO_API.GET_NAME (:CREATE_PERSON)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCREATEPERSONNAME: Create Person Name").
                 setSize(30).
                 setFunction("PERSON_INFO_API.GET_NAME ( :CREATE_PERSON)").
                 setReadOnly();
         ...
         headblk.addField("START_ORG").
                 ...
                 setDefaultNotVisible().
                 setDynamicLOV("GENERAL_ORGANIZATION_LOV", "PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSTARTORG: Start Org").
                 setSize(30);
         headblk.addField("START_ORG_NAME").
                 setFunction("GENERAL_ORGANIZATION_API.Get_Org_Desc(:START_ORG)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSTARTORGNAME: Start Org Name").
                 setDefaultNotVisible().
                 setSize(30).
                 setReadOnly();
         ...
         headblk.addField("CREATE_TIME","Date").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCREATETIME: Create Time").
                 setSize(30);
         headblk.addField("REPLY_LIST_NO").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYREPLYLISTNO: Reply List No").
                 setSize(30);
         headblk.addField("BOOK_NO").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYBOOKNO: Book No").
                 setSize(30);
         headblk.addField("BOOK_NAME").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYBOOKNAME: Book Name").
                 setSize(30);
         headblk.addField("ESTIMATE_COST").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYESTIMATECOST: Estimate Cost").
                 setSize(30);
         headblk.addField("ACTUAL_COST").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYACTUALCOST: Actual Cost").
                 setSize(30);
         headblk.addField("CONTRACT_NO").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCONTRACTNO: Contract No").
                 setSize(30);       
         headblk.addField("NOTE").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYNOTE: Note").
                 setSize(2000);
         headblk.addField("STATUS").
                 setHidden().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSTATUS: Status").
                 setSize(30);
         headblk.addField("STATUS_DESC").
                 setReadOnly().
                 setFunction("FLOW_STATUS_API.Get_Status_Desc (:STATUS)").
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYSTATUSDESC: Status Desc").
                 setSize(30);
         headblk.addField("CONTENT").
                 setInsertable().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTINNERREPLYCONTENT: Content").
                 setSize(130).
                 setHeight(5);
         ...
         headbar.addCustomCommand("printReport", "CONPROJCONNECTIONLISTINNERREPLYREPORT: Print Proj Connection List Inner Reply Report...");//TODO
    ...
    //Report  Function
       ...
       if (headset.countRows()>0 )
             {   
                ...
                String id = headset.getValue("ID");
                 appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptConProjConnectionListInnerReply.raq&proj_no="+proj_no+"&id="+id
      ...
      {
         return "CONPROJCONNECTIONLISTINNERREPLYDESC: Con Proj Connection List Inner Reply";
      }
