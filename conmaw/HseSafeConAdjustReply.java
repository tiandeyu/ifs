...
public class HseSafeConAdjustReply extends HzASPPageProviderWf
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.HseSafeConAdjustReply");
   ...
   public  HseSafeConAdjustReply (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
...
//              setSize(30);
      ...
      headbar.addCustomCommand("printReport", "HSESAFECONADJUSTREPLYREPORT: Print Safe Adjust Reply Report...");//TODO
      headtbl = mgr.newASPTable(headblk);
      headtbl.setTitle("HSESAFECONADJUSTREPLYTBLHEAD: Hse Safe Con Adjust Replys");
 ...
 //Report  Function
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String id = headset.getValue("ID");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=HseSafeConAdjustReply.raq&proj_no="+proj_no+"&id="+id
   ...
   {
      return "HSESAFECONADJUSTREPLYDESC: Hse Safe Con Adjust Reply";
   }


   protected String getTitle()
   {
      return "HSESAFECONADJUSTREPLYTITLE: Hse Safe Con Adjust Reply";
   }
