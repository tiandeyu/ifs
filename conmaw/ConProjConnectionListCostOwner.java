...
public class ConProjConnectionListCostOwner extends HzASPPageProviderWf {

   public ConProjConnectionListCostOwner(ASPManager mgr, String pagePath) {
      super(mgr, pagePath);
   }
      // TODO Auto-generated constructor stub
      public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConProjConnectionListCostOwner");
      ...
      public void okFind()
      {
         ...
         q.includeMeta("ALL");
         q.addWhereCondition("CON_LIST_TYPE_DB = 'COSTOWNER'");
      ...
      public void newRow()
      {
         ...
         data.setFieldItem("CON_LIST_TYPE_DB", "COSTOWNER");
...
//                 setLOVProperty("WHERE", "SCHEDULE='TRUE'").
         ...
         headblk.addField("IS_REPLY").
                 ...
                 setSize(30);
         //Only in this page. Send_to&Copy_to served as Construction_org&Supervising_org.
         headblk.addField("SEND_TO").
                 setMandatory().
                 setDefaultNotVisible().
                 setInsertable().
                 setDynamicLOV("GENERAL_ORGANIZATION_LOV", "PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTCOSTOWNERSENDTO: Send To").
                 setSize(30);
         headblk.addField("SEND_TO_NAME").
                 setFunction("GENERAL_ORGANIZATION_API.Get_Org_Desc( :SEND_TO)").
                 setReadOnly().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTCOSTOWNERSENDTONAME: Send To Name").
                 setSize(30);
         ...
         headblk.addField("COPY_TO").
                 ...
                 setInsertable().
                 setDynamicLOV("GENERAL_ORGANIZATION_LOV", "PROJ_NO").
                 setLabel("CONPROJCONNECTIONLISTCOSTOWNERCOPYTO: Copy To").
                 setSize(30);
         headblk.addField("COPY_TO_NAME").
                 setFunction("GENERAL_ORGANIZATION_API.Get_Org_Desc(:COPY_TO)").
                 setReadOnly().
                 setDefaultNotVisible().
                 setLabel("CONPROJCONNECTIONLISTCOSTOWNERCOPYTONAME: Copy To Name").
                 setSize(30);
         ...
         headbar.addCustomCommand("printReport", "CONPROJCONNECTIONLISTCOSTOWNERREPORT: Print Proj Connection List Cost Owner Report...");//TODO
    ...
    //Report  Function
       ...
       if (headset.countRows()>0 )
             {   
                ...
                String id = headset.getValue("ID");
                 appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptConProjConnectionListCostOwner.raq&proj_no="+proj_no+"&id="+id
      ...
      {
         return "CONPROJCONNECTIONLISTCOSTOWNERDESC: Con Proj Connection List Cost Owner";
      }
