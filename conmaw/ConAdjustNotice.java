...
public class ConAdjustNotice extends HzASPPageProviderWf
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConAdjustNotice");
   ...
   public  ConAdjustNotice (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
...
//              setLOVProperty("WHERE", "SCHEDULE = 'TRUE'").
      ...
      headbar.addCustomCommand("printReport", "CONADJUSTNOTICEREPORT: Print Adjust Notice Report...");//TODO
      headtbl = mgr.newASPTable(headblk);
      headtbl.setTitle("CONADJUSTNOTICETBLHEAD: Con Adjust Notices");
...
//      headlay.setDataSpan("CONTRACT_NO", 5);
 ...
 //Report  Function
    ...
    if (headset.countRows()>0 )
          {   
             ...
             String id = headset.getValue("ID");
              appendDirtyJavaScript("window.open('"+URL+"/showReport.jsp?raq=RptConAdjustNotice.raq&proj_no="+proj_no+"&id="+id
   ...
   {
      return "CONADJUSTNOTICEDESC: Con Adjust Notice";
   }


   protected String getTitle()
   {
      return "CONADJUSTNOTICETITLE: Con Adjust Notice";
   }
