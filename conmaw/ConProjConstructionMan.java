...
public class ConProjConstructionMan extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.conmaw.ConProjConstructionMan");
...
//   private ASPBlockLayout headlay;
   ...
   public  ConProjConstructionMan (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
...
//      Pending_doc_reference_object_blk.setMasterBlock(headblk);
      ...
      headlay.defineGroup(mgr.translate("QUANLITYSTANDARDLINETBLITEMORG: Check Org Info"),"CONSTRUCT_ORG,SURVEY_ORG,DESIGN_ORG,SUPERVISION_ORG,BULIDING_ORG,MANUFACTURE_ORG,CON_UNIT_TEAM,CON_UNIT_SITE,CON_UNIT_QC,CON_UNIT_PROFE_COMPANY", true, false);
