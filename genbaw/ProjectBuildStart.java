...
public class ProjectBuildStart extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("ifs.genbaw.ProjectBuildStart");
   ...
   public  ProjectBuildStart (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
   ...
   public void okFind()
   {
      ...
      q.addParameter("PROJECT_BUILD_DB", "3");
      q.includeMeta("ALL");
      ...
      {
         mgr.showAlert("PROJECTBUILDSTARTNODATA: No data found.");
         headset.clear();
      }
   ...
   public void newRow()
   {
      ...
      cmd.setParameter("PROJECT_BUILD_DB", "3");
   ...
   public void  preDefine()
   {
      ...
      headblk.addField("APPLY_NO").
              setMandatory().
              setInsertable().
              setLabel("PROJECTBUILDSTARTAPPLYNO: Apply No").
              setSize(15);
      headblk.addField("APPLY_NAME").
              setInsertable().
              setLabel("PROJECTBUILDSTARTAPPLYNAME: Apply Name").
              setSize(30);
      headblk.addField("PROJECT_NO").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTNO: Project No").
              setSize(20);
      headblk.addField("PROJECT_PHASE").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTPHASE: Project Phase").
              setSize(20);
      headblk.addField("PROJECT_AREA").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTAREA: Project Area").
              setSize(20);
      headblk.addField("PROJECT_ADD").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTADD: Project Add").
              setSize(30);
      headblk.addField("PROJECT_SIZE").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTSIZE: Project Size").
              setSize(20);
      headblk.addField("PROJECT_SIZE_DESC").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPROJECTSIZEDESC: Project Size Desc").
              setSize(30);
      headblk.addField("MESSAGE_PERSON").
              setInsertable().
              setLabel("PROJECTBUILDSTARTMESSAGEPERSON: Message Person").
              setSize(20);
      headblk.addField("APPLY_NUM","Number").
              setInsertable().
              setLabel("PROJECTBUILDSTARTAPPLYNUM: Apply Num").
              setSize(15);
      headblk.addField("WORK_STATE").
              setInsertable().
              setLabel("PROJECTBUILDSTARTWORKSTATE: Work State").
              setSize(20);
      headblk.addField("CHECK_DEPT").
		      setInsertable().
		      setLabel("PROJECTBUILDSTARTCHECKDEPT: Check Dept").
		      setSize(20);
      headblk.addField("CHECK_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTCHECKDATE: Check Date").
              setSize(20);
      headblk.addField("ALLOW_DESC").
              setInsertable().
              setLabel("PROJECTBUILDSTARTALLOWDESC: Allow Desc").
              setSize(20);
      headblk.addField("CHECK_DESC").
              setInsertable().
              setLabel("PROJECTBUILDSTARTCHECKDESC: Check Desc").
              setSize(20);
      headblk.addField("PLAN_START_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTPLANSTARTDATE: Plan Start Date").
              setSize(20);
      headblk.addField("ACTUAL_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTACTUALDATE: Actual Date").
              setSize(20);
      headblk.addField("REPORT_VALUE","Number").
              setInsertable().
              setLabel("PROJECTBUILDSTARTREPORTVALUE: Report Value").
              setSize(20);
      headblk.addField("CONFIRM_VALUE","Number").
              setInsertable().
              setLabel("PROJECTBUILDSTARTCONFIRMVALUE: Confirm Value").
              setSize(20);
      headblk.addField("APPLY_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTAPPLYDATE: Apply Date").
              setSize(20);
      headblk.addField("CONFIRM_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTCONFIRMDATE: Confirm Date").
              setSize(20);
      headblk.addField("CANCEL_DATE","Date").
              setInsertable().
              setLabel("PROJECTBUILDSTARTCANCELDATE: Cancel Date").
              setSize(20);
      headblk.addField("NOTE").
              setInsertable().
              setLabel("PROJECTBUILDSTARTNOTE: Note").
              setSize(30);
      headblk.addField("PROJECT_BUILD_DB").
		      setHidden();
      headblk.addField("STATE").
              setLabel("PROJECTBUILDSTARTSTATE: State").
              setSize(10);
      ...
      headtbl.setTitle("PROJECTBUILDSTARTTBLHEAD: Project Builds");
      ...
      project_build_app_blk.addField("ITEM0_APPLY_NO").
                            ...
                            setHidden().
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPITEM0APPLYNO: Apply No").
                            setSize(10);
      project_build_app_blk.addField("LINE_NO").
                            setMandatory().
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPLINENO: Line No").
                            setSize(15);
      project_build_app_blk.addField("WORK_FILE_TYPE").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPWORKFILETYPE: Work File Type").
                            setSize(30);
      project_build_app_blk.addField("FILE_NO").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPFILENO: File No").
                            setSize(20);
      project_build_app_blk.addField("FILE_NAME").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPFILENAME: File Name").
                            setSize(30);
      project_build_app_blk.addField("FILE_TIME","Date").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPFILETIME: File Time").
                            setSize(20);
      project_build_app_blk.addField("OPERATOR_PERSON").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPOPERATORPERSON: Operator Person").
                            setSize(20);
      project_build_app_blk.addField("CHARGE_PERSON").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPCHARGEPERSON: Charge Person").
                            setSize(20);
      project_build_app_blk.addField("ITEM0_WORK_STATE").
                            setDbName("WORK_STATE").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPITEM0WORKSTATE: Work State").
                            setSize(20);
      project_build_app_blk.addField("CONFIRM_DESC").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPCONFIRMDESC: Confirm Desc").
                            setSize(30);
      project_build_app_blk.addField("IS_FILE").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPISFILE: Is File").
                            setSize(10);
      project_build_app_blk.addField("ITEM0_NOTE").
                            setDbName("NOTE").
                            setInsertable().
                            setLabel("PROJECTBUILDSTARTAPPITEM0NOTE: Note").
                            setSize(30);
      ...
      project_build_app_tbl.setTitle("PROJECTBUILDSTARTAPPITEMHEAD1: ProjectApp");
      ...
      project_build_confirm_blk.addField("ITEM1_APPLY_NO").
                                ...
                                setHidden().
                                setInsertable().
                                setLabel("PROJECTBUILDSTARTCONFIRMITEM1APPLYNO: Apply No").
                                setSize(10);
      project_build_confirm_blk.addField("ITEM1_FILE_NO").
                                setDbName("FILE_NO").
                                setMandatory().
                                setInsertable().
                                setLabel("PROJECTBUILDSTARTCONFIRMITEM1FILENO: File No").
                                setSize(20);
      project_build_confirm_blk.addField("ITEM1_FILE_NAME").
                                setDbName("FILE_NAME").
                                setInsertable().
                                setLabel("PROJECTBUILDSTARTCONFIRMITEM1FILENAME: File Name").
                                setSize(30);
      project_build_confirm_blk.addField("ITEM1_FILE_TIME","Date").
                                setDbName("FILE_TIME").
                                setInsertable().
                                setLabel("PROJECTBUILDSTARTCONFIRMITEM1FILETIME: File Time").
                                setSize(20);
      project_build_confirm_blk.addField("ITEM1_IS_FILE").
                                setDbName("IS_FILE").
                                setInsertable().
                                setLabel("PROJECTBUILDSTARTCONFIRMITEM1ISFILE: Is File").
                                setSize(10);
      ...
      project_build_confirm_tbl.setTitle("PROJECTBUILDSTARTCONFIRMITEMHEAD2: ProjectConfirm");
      ...
      tabs.addTab(mgr.translate("PROJECTBUILDSTARTAPPTITLE: Build App"), "javascript:commandSet('MAIN.activateITEM1','')");
      tabs.addTab(mgr.translate("PROJECTBUILDSTARTCONFIRMTITLE:  Build Confirm"), "javascript:commandSet('MAIN.activateITEM2','')"); 
   ...
   {
      return "PROJECTBUILDSTARTDESC: Project Build Start";
   }


   protected String getTitle()
   {
      return "PROJECTBUILDSTARTTITLE: Project Build Start";
   }
