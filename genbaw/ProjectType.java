...
public class ProjectType extends ASPPageProvider
{
   ...
   public static boolean DEBUG = Util.isDebugEnabled("genbaw.ProjectType");
   ...
   public  ProjectType (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
