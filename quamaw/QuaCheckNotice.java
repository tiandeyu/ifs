...
public class QuaCheckNotice extends ConCheckNotice
{
...
//   private ASPBlockLayout headlay;
   ...
   public  QuaCheckNotice (ASPManager mgr, String page_path)
   {
      super(mgr,page_path);
   }
...
//   }
   ...
   public void okFind()
   {
      ...
      q.addParameter("CON_CHECK_LIST_TYPE_DB","QUALITY");
      q.includeMeta("ALL");
   ...
   public void newRow()
   {
      ...
      data.setFieldItem("CON_CHECK_LIST_TYPE_DB", "QUALITY");
      headset.addRow(data);
   }
